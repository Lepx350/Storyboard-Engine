...
CHARACTERS = {
    "peys": {
        "name": "Detective Peys",
        "alias": ["Peys", "detective", "Detective Peys", "Patrick Peys"],
        "desc": "Middle-aged man, dark wool overcoat, gray scarf, short-cropped gray hair, sturdy build",
        "views": {
    ...
    "leo": {
        "name": "Notarbartolo",
        "alias": ["Notarbartolo", "Leonardo", "Italian man", "charcoal suit", "charcoal tailored suit", "navy three-piece", "tailored dark navy"],
        "desc": "Late forties, dark slicked-back hair, charcoal tailored suit, black turtleneck, silver wristwatch",
        "views": {
            "front": "CHARACTER REFERENCE — FRONT VIEW. Man in late forties, dark slicked-back hair, charcoal tailored suit, black turtleneck, silver wristwatch on left wrist, lean athletic build. Olive-toned smooth mannequin skin. Confident, one hand in pocket.",
            "three_quarter": "CHARACTER REFERENCE — 3/4 VIEW. Man in late forties, dark slicked-back hair, charcoal suit, turtleneck, silver wristwatch. Olive-toned smooth mannequin skin. Looking to the side.",
            "action": "CHARACTER REFERENCE — ACTION POSE. Man in charcoal suit and turtleneck, slicked-back hair. Leaning over desk examining documents, silver wristwatch visible. Olive-toned smooth mannequin skin.",
        },
    },
    "speedy": {
        "name": "Speedy",
        "alias": ["Speedy", "lookout", "thin wiry man", "dark canvas jacket", "black wool beanie", "brown leather jacket", "worn brown leather"],
        "desc": "Thin wiry build, dark canvas jacket, black wool beanie cap, nervous posture",
        "views": {
            "front": "CHARACTER REFERENCE — FRONT VIEW. Thin wiry man in dark canvas jacket and black wool beanie cap. Nervous posture, shoulders hunched. Pale smooth mannequin skin.",
            "three_quarter": "CHARACTER REFERENCE — 3/4 VIEW. Thin wiry man in dark canvas jacket and beanie. Pale smooth mannequin skin. Looking over shoulder nervously.",
            "action": "CHARACTER REFERENCE — ACTION POSE. Thin wiry man in dark jacket and beanie sitting in car, hands gripping steering wheel tensely. Pale smooth mannequin skin.",
        },
    },
    "monster": {
        "name": "The Monster",
        "alias": ["Monster", "Finotto", "tall muscular", "dark work coveralls", "heavy boots", "dark coveralls"],
        "desc": "Tall muscular broad-shouldered man, dark work coveralls, black leather gloves, heavy boots",
        "views": {
            "front": "CHARACTER REFERENCE — FRONT VIEW. Tall muscular broad-shouldered man in dark work coveralls, black leather gloves, heavy boots. Light-toned smooth mannequin skin. Arms crossed.",
            "three_quarter": "CHARACTER REFERENCE — 3/4 VIEW. Tall muscular man in dark coveralls and leather gloves. Light-toned smooth mannequin skin. Powerful build visible.",
            "action": "CHARACTER REFERENCE — ACTION POSE. Tall muscular man in dark coveralls working on a lock mechanism with tools. Light-toned smooth mannequin skin.",
        },
    },
    "genius": {
        "name": "The Genius",
        "alias": ["Genius", "wire-rimmed glasses", "wire-frame glasses", "dark hoodie", "olive utility vest", "olive vest", "latex gloves", "tactical vest", "turtleneck"],
        "desc": "Medium build, wire-rimmed glasses, dark hoodie under olive utility vest, latex gloves",
        "views": {
            "front": "CHARACTER REFERENCE — FRONT VIEW. Medium-build man with wire-rimmed glasses, dark hoodie under olive utility vest, latex gloves. Light-toned smooth mannequin skin. Technical posture.",
            "three_quarter": "CHARACTER REFERENCE — 3/4 VIEW. Medium-build man with glasses, dark hoodie, olive vest, latex gloves. Light-toned smooth mannequin skin. Examining something.",
            "action": "CHARACTER REFERENCE — ACTION POSE. Man in hoodie and olive vest with latex gloves working on electronic circuit board. Wire-rimmed glasses. Light-toned smooth mannequin skin.",
        },
    },
    "king": {
        "name": "King of Keys",
        "alias": ["King of Keys", "older man", "white hair", "gray thinning hair", "reading glasses on neck chain", "wool sweater", "wool coat", "leather gloves"],
        "desc": "Older man, white hair, weathered hands, dark wool sweater, reading glasses on neck chain",
        "views": {
            "front": "CHARACTER REFERENCE — FRONT VIEW. Older man with white hair, weathered hands, dark wool sweater, reading glasses on neck chain, slim build. Light-toned smooth mannequin skin. Holding a brass key.",
            "three_quarter": "CHARACTER REFERENCE — 3/4 VIEW. Older man with white hair, wool sweater, glasses on chain. Light-toned smooth mannequin skin. Examining key held to light.",
            "action": "CHARACTER REFERENCE — ACTION POSE. Older man in dark wool sweater, glasses on chain, white hair. Working on key cutting at workbench. Light-toned smooth mannequin skin.",
        },
    },
    "vancamp": {
        "name": "Van Camp",
        "alias": ["Van Camp", "August", "retired grocer", "red plaid flannel", "plaid flannel", "stocky", "khaki work"],
        "desc": "Fifty-nine, stocky build, red plaid flannel shirt, khaki work pants, muddy boots",
        "views": {
            "front": "CHARACTER REFERENCE — FRONT VIEW. Fifty-nine year old stocky man in red plaid flannel shirt, khaki work pants, muddy boots, reading glasses. Light-toned smooth mannequin skin.",
            "three_quarter": "CHARACTER REFERENCE — 3/4 VIEW. Stocky man in red plaid flannel, khaki pants, muddy boots. Light-toned smooth mannequin skin. Holding trash grabber.",
            "action": "CHARACTER REFERENCE — ACTION POSE. Stocky man in red plaid flannel crouching on dirt path examining debris. Reading glasses, muddy boots. Light-toned smooth mannequin skin.",
        },
    },
}
...
ENVIRONMENTS = {
    "vault_interior": {"name": "Vault Interior", "keywords": ["vault", "safe deposit box", "boxes", "vault room"],
    ...
    "vault_door": {"name": "Vault Door", "keywords": ["vault door", "massive circular", "heavy metal door"],
        "prompt_detail": "ENVIRONMENT REFERENCE — EMPTY. Massive circular steel vault door in concrete wall. Heavy metal frame. Single overhead light. Underground. Wide 16:9. No people."},
    "corridor": {"name": "Corridor", "keywords": ["corridor", "hallway", "stairwell", "stairs"],
    ...
    "office": {"name": "Office", "keywords": ["office", "desk", "conference", "meeting"],
    ...
    "exterior": {"name": "Building Exterior", "keywords": ["exterior", "building", "diamond centre", "facade", "street"],
        "prompt_detail": "ENVIRONMENT REFERENCE — EMPTY. Imposing stone European building exterior. Grand old architecture. Overcast sky. Dramatic low angle. Wide 16:9. No people."},
    "garage": {"name": "Garage", "keywords": ["garage", "parking", "underground"],
        "prompt_detail": "ENVIRONMENT REFERENCE — EMPTY. Underground parking garage. Concrete ramp into darkness. Yellow sodium lights. Nighttime. Wide 16:9. No people."},
    "apartment": {"name": "Apartment", "keywords": ["apartment", "table", "divide", "split the take"],
    ...
    "vancamp_house": {"name": "Van Camp's Property", "keywords": ["van camp", "countryside", "property", "garden", "rural", "porch", "forest", "dirt road", "dirt path", "wooded"],
        "prompt_detail": "ENVIRONMENT REFERENCE — EMPTY. Modest Belgian countryside house at dawn. Garden, fence, trees. Dirt path to forest. Quiet rural morning. Wide 16:9. No people."},
    "highway": {"name": "Highway", "keywords": ["highway", "motorway", "E19", "road", "driving"],
        "prompt_detail": "ENVIRONMENT REFERENCE — EMPTY. European highway at night. Empty road into darkness. Forest both sides. Wet asphalt. Wide 16:9. No people."},
    ...
    "press_conference": {"name": "Press Conference", "keywords": ["press conference", "press room", "media briefing", "podium", "microphones", "cameras"],
        "prompt_detail": "ENVIRONMENT REFERENCE — EMPTY. Police press conference room. Podium with multiple microphones, backdrop with official logos. Harsh overhead lighting, rows of chairs. Institutional. Wide 16:9. No people."},
    "police_station": {"name": "Police Station", "keywords": ["police", "station", "interrogation", "interview room", "detective office"],
    ...
    "aerial_city": {"name": "Antwerp Aerial", "keywords": ["aerial", "skyline", "city", "antwerp", "overview", "bird"],
        "prompt_detail": "ENVIRONMENT REFERENCE — EMPTY. Dramatic aerial view of Antwerp city at dusk. Diamond district visible. Cathedral spire. Overcast sky, golden hour light breaking through clouds. Cinematic establishing shot. Wide 16:9. No people."},
}
...
MASTER_SHOT_DETAILS = {
    ...
    "vancamp_house": "MASTER SHOT — HERO RENDER. August Van Camp's modest Belgian countryside property at dawn. Small brick house with chimney, neat garden behind low fence. Bare winter trees. Dirt path leading from house toward dark forest in background. Mailbox at gate. Quiet, rural, ordinary. Early morning overcast light. Camera: wide establishing shot from road. 16:9. No people.",
    ...
    "press_conference": "MASTER SHOT — HERO RENDER. Police press conference room. Dark podium center frame with cluster of microphones. Official Belgian police backdrop. Harsh overhead lighting, camera flash effects. Rows of empty chairs facing podium. Tense, institutional. Camera: medium wide from back of room. 16:9. No people.",
